...
6. CLOSE
   ...
   The server also exits by itself 60 s after the page goes away - that clock
   starts at the first connection, so a URL nobody has opened yet gets 10
   minutes - and after --idle seconds (default 14400 = 4h) without a batch,
   poll, reply or page write.
